    ...
    public class ArticuloNegocio
    {
        public List<Articulo> listar(string id = "")
        {
            ...
            try
            {
                ...
                comando.CommandText = "Select A.Id, Codigo , Nombre, M.Descripcion Marca, C.Descripcion Categoria, A.Descripcion, ImagenUrl ,Precio,A.IdMarca, A.IdCategoria  from ARTICULOS A, MARCAS M , CATEGORIAS C  WHERE(A.IdMarca = M.Id) and A.IdCategoria ";
                if(id != "")
